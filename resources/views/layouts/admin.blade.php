...
<a href="{{ url('/') }}" class="logo-image d-inline-block">
    <img src="{{ asset('frontend/assets/img/logo/suguba.png') }}" alt="SUGUBA Logo" style="max-height: 50px; width: auto;">
</a>
            </a>
            ...
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                  ...
                  <li class="menu-item">
                    ...
                    <li class="menu-item">
                      <a href="app-user-list.html" class="menu-link">
                        <div data-i18n="Gestion des plaintes ">Gestion des plaintes </div>
                      </a>
                    </li>
    ...
    <div data-i18n="Sous-catégories">Sous-catégories</div>
            ...
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                  ...
                  <li class="menu-item">
                    <a href="wizard-ex-create-deal.html" class="menu-link">
                      <div data-i18n="Performances">Performances</div>
                    </a>
                  </li>
                </ul>
              </li>
