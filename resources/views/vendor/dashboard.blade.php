                ...
                <ul class="menu-inner py-1">
                  ...
                  <li class="menu-item">
                      <a href="javascript:void(0);" class="menu-link menu-toggle">
                          ...
                          <div data-i18n="Discussion">Discussion</div>
                      </a>

                      <ul class="menu-sub">
                        <li class="menu-item">
                          <a href="app-user-list.html" class="menu-link">
                            <div data-i18n="Conversation">Conversation </div>
                          </a>
                        </li>
                        <li class="menu-item">
                            <a href="app-user-list.html" class="menu-link">
                    ...
                    <ul class="menu-sub">
                      ...
                      <li class="menu-item">
                        ...
                        <li class="menu-item">
                          ...
                          <li class="menu-item">
                            <a href="app-user-view-security.html" class="menu-link">
                              <div data-i18n="Étiquettes">Étiquettes</div>
                            </a>
                          </li>
                    </ul>
                  </li>
                  <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                      ...
                      <li class="menu-item">
                        ...
                        <li class="menu-item">
                          <a href="app-access-permission.html" class="menu-link">
                            <div data-i18n="Paramètres du site">Paramètres du site</div>
                          </a>
                        </li>
                    </ul>
                  </li>
                  <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                      <i class="menu-icon tf-icons fa fa-shop"></i>
                    ...
                    <ul class="menu-sub">
                      ...
                      <li class="menu-item">
                          <a href="app-access-permission.html" class="menu-link">
                            <div data-i18n="Frais d'expedition">Frais d'expedition </div>
                          </a>
                        </li>
                        <li class="menu-item">
                          <a href="app-access-permission.html" class="menu-link">
                        ...
                        <li class="menu-item">
                          ...
                          <li class="menu-item">
                            <a href="app-access-permission.html" class="menu-link">
                              <div data-i18n="Alertes de stock ">Alertes de stock </div>
                            </a>
                          </li>
                    </ul>
                  </li>
                  <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                      <li class="menu-item">
                        <a href="app-access-roles.html" class="menu-link">
                          <div data-i18n="Suivi">Suivi</div>
                        </a>
                      </li>
                      <li class="menu-item">
                        <a href="app-access-permission.html" class="menu-link">
                          <div data-i18n="Produits plus vendus">Produits plus vendus</div>
                        </a>
                      </li>
                      <li class="menu-item">
                          <a href="app-access-permission.html" class="menu-link">
                            <div data-i18n="Rapports de ventes">Rapports de ventes </div>
                          </a>
                        </li>
                        <li class="menu-item">
                          <a href="app-access-permission.html" class="menu-link">
                            <div data-i18n="Promotions & Remises ">Promotions & Remises </div>
                          </a>
                        </li>
                        <li class="menu-item">
                            <a href="app-access-permission.html" class="menu-link">
                              <div data-i18n="Paniers ">Paniers </div>
                            </a>
                          </li>
                          <!--li class="menu-item">
                            <a href="app-access-permission.html" class="menu-link">
                    ...
                    <ul class="menu-sub">
                      ...
                      <li class="menu-item">
                        <a href="wizard-ex-create-deal.html" class="menu-link">
                          <div data-i18n="Problèmes">Problèmes</div>
                        </a>
                      </li>
                    </ul>
                  </li>
                  ...
                  <li class="menu-item">
                      ...
                      <ul class="menu-sub">
                        ...
                        <li class="menu-item">
                          <a href="wizard-ex-create-deal.html" class="menu-link">
                            <div data-i18n="Tendanse">Tendanse</div>
                          </a>
                        </li>
                      </ul>
                    </li>
                    ...
                    <ul class="menu-sub">
                      <li class="menu-item">
                        <a href="icons-tabler.html" class="menu-link">
                          <div data-i18n="Nouvelles commandes">Nouvelles commandes</div>
                        </a>
                      </li>
                      <li class="menu-item">
                      ...
                      <li class="menu-item">
                        <a href="icons-font-awesome.html" class="menu-link">
                          <div data-i18n="Retour">Retour</div>
                        </a>
                      </li>
                    </ul>
                  </li>
                  <li class="menu-item">
                      ...
                      <ul class="menu-sub">
                        ...
                        <li class="menu-item">
                          <a href="icons-font-awesome.html" class="menu-link">
                            <div data-i18n="Erreurs">Erreurs</div>
                          </a>
                        </li>
                      </ul>
                    </li>
